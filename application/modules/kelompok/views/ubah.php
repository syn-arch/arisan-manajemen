                   ...
                   <div class="col-md-8">
                       <form method="POST" enctype="multipart/form-data">
                        <div class="form-group <?php if(form_error('id_kelompok')) echo 'has-error'?>">
                          ...
                          <input readonly="" type="text" id="id_kelompok" name="id_kelompok" class="form-control" value="<?php echo $kelompok['id_kelompok'] ?>">
                          <?php echo form_error('id_kelompok', '<small style="color:red">','</small>') ?>
                           ...
                           <div class="form-group <?php if(form_error('nama_kelompok')) echo 'has-error'?>">
                               ...
                               <input type="text" id="nama_kelompok" name="nama_kelompok" class="form-control nama_kelompok" placeholder="Nama kelompok" value="<?php echo $kelompok['nama_kelompok'] ?>">
