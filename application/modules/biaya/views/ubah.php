      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          ...
          <div class="pull-right">
            <div class="box-title">
              <a href="<?php echo base_url('biaya') ?>" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
          </div>
        </div>
        <div class="box-body">
         <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group <?php if(form_error('id_biaya')) echo 'has-error'?>">
              ...
              <input readonly="" type="text" id="id_biaya" name="id_biaya" class="form-control id_biaya " placeholder="ID biaya" value="<?php echo $biaya['id_biaya'] ?>">
            ...
            <div class="form-group <?php if(form_error('tgl')) echo 'has-error'?>">
              ...
              <input required="" type="datetime-local" id="tgl" name="tgl" class="form-control tgl " placeholder="Tanggal" value="<?php echo date("Y-m-d\TH:i:s", strtotime($biaya['tgl'])) ?>">
              <?php echo form_error('tgl', '<small style="color:red">','</small>') ?>
            </div>
            <div class="form-group">
              <label for="keterangan_biaya">Nama Biaya</label>
              <input type="text" id="keterangan_biaya" name="keterangan_biaya" class="form-control keterangan_biaya <?php if(form_error('keterangan_biaya')) echo 'is-invalid'?>" placeholder="Biaya" value="<?php echo $biaya['keterangan_biaya'] ?>">
              <?php echo form_error('keterangan_biaya', '<small style="color:red">','</small>') ?>
            </div>
            <div class="form-group">
              <label for="total_bayar">Total</label>
              <input type="text" id="total_bayar" name="total_bayar" class="form-control total_bayar <?php if(form_error('total_bayar')) echo 'is-invalid'?>" placeholder="Total" value="<?php echo $biaya['total_bayar'] ?>">
          ...
          <div class="col-md-6">
            <div class="form-group <?php if(form_error('keterangan')) echo 'has-error'?>">
              ...
              <textarea name="keterangan" id="keterangan" cols="30" rows="5" class="form-control" placeholder="Keterangan"><?php echo $biaya['keterangan'] ?></textarea>
            ...
            <div class="form-group">
              ...
              <select name="id_outlet" id="id" class="form-control select2">
                <?php foreach ($outlet as $row): ?>
                  <option <?php echo $row['id_outlet'] == $biaya['id_outlet'] ? 'selected' : '' ?> value="<?php echo $row['id_outlet'] ?>"><?php echo $row['nama_outlet'] ?></option>
                <?php endforeach ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select name="status" id="status" class="form-control">
                <option value="PENGELUARAN" <?php echo $biaya['status'] == 'PENGELUARAN' ? 'selected' : '' ?>>PENGELUARAN</option>
                <option value="PEMASUKAN" <?php echo $biaya['status'] == 'PEMASUKAN' ? 'selected' : '' ?>>PEMASUKAN</option>
                </select>
